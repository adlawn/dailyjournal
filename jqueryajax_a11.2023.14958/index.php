...
<html lang="en">
      ...
      <div class="container">
        <div class="row d-flex align-items-center">
          ...
          <div class="col-md-6">
            ...
            <h4 class="lead display-6">Mencatat 4 hari kegiatan saya</h4>
          </div>
        </div>
      </div>
    </section>
  ...
  <div class="container">
    ...
    <section id="profil" class="p-5 bg-primary-subtle">
      ...
      >
        <div class="row d-flex align-items-center justify-content-center">
          ...
          >
            <div class="card-body">
              <h5 class="card-title">Wahyu Bahydestaqy Ardiananda</h5>
              <br />
              <h6 class="card-text"><b>NIM</b>: A11.2023.14958</h6>
              <h6 class="card-text">
                <b>Program Studi</b>: Teknik Informatika
              </h6>
              <h6 class="card-text"><b>Email</b>: bahydestaqy@gmail.com</h6>
              <h6 class="card-text"><b>Telpon</b>: 084562456789</h6>
              <h6 class="card-text"><b>Alamat</b>: JL.Rambutan II Semarang</h6>
            </div>
          </div>
        </div>
      </div>
    ...
    <footer class="text-center p-5">
      ...
      <div>Wahyu Bahydestaqy A @2024</div>
    </footer>
    <!-- /footer -->
